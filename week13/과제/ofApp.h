...
public:
	...
	int traceNum = 0; // number of trace(passed cells)
	...
	// --------- Function and variables for executing BFS ---------
	void BFS();

	typedef struct bfsCell {
		int row_idx;
		int col_idx;
		struct bfsCell *parent;
	} bfsCell;
	...
	bfsCell *queueArray[10000];
	struct bfsCell *current;
